...
namespace IoTService
{
    class ReadDeviceToCloudMessages
    {
        ...
        private readonly static string s_eventHubsCompatibleEndpoint = "{{endpoint}}";
        ...
        private static async Task Start(string[] args)
        {
            ...
            Console.WriteLine("**Parition Count " + runtimeInfo.PartitionCount);
        ...
        {
            ReadDeviceToCloudMessages.Start(args);
            Console.ReadLine();
        }
